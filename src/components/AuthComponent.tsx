            ...
            <ImageBackground style={styles.background} source={require('../assets/images/psw-bg.jpg')}>
                <View style={styles.container}>
                    ...
                    <View style={styles.inputContainer}>
                        <TextInput onChangeText={(username) => this.setState({username})} style={styles.input} placeholder={lang.email}/>
                        <TextInput secureTextEntry={true} onChangeText={(password) => this.setState({password})} style={styles.input} placeholder={lang.haslo}/>
                        <View style={styles.buttonStyle}>
                            <Button color={'#fff'} title={lang.login} onPress={() => { this.onButtonPressed() }}></Button>
                        </View>
                    </View>
                </View>
            </ImageBackground>
